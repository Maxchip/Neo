...
<script type="text/javascript">
        ...
        if (IdDoc > 0) {
            ...
            $.ajax({
                ...
                success: function (data) {               
                    ...
                    dateCadastro.SetText(data["Doc"][0].DataCadastro);
    ...
    function OnVencimento(s, e) {
        if (chkVencimento.GetValue() == true) {
            ...
            txtVencimento.SetIsValid(false);
        }
        else {
            dateVencimento.SetValue(null);
                ...
                <div class="row">
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-sm-2 col-md-2 col-lg-2">
                            <dx:ASPxDateEdit ID="dateCadastro" Caption="Cadastro" runat="server" ClientInstanceName="dateCadastro" ReadOnly="true"
                                DisplayFormatString="dd/MM/yyyy" EditFormatString="dd/MM/yyyy" Width="100%" DropDownButton-Enabled="false">
                                <CaptionSettings Position="Top" ShowColon="false" />
                            </dx:ASPxDateEdit>
                        </div>

                        <div class="col-sm-2 col-md-2 col-lg-2">
                            <dx:ASPxComboBox ID="cboTipo" runat="server" ValueType="System.Int32" ValueField="IdTipoDoc" ClientInstanceName="cboTipo" TextField="NomeTipoDoc"
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        ...
                        <div class="col-sm-3 col-md-3 col-lg-3">
                            <dx:ASPxComboBox ID="cboUsuario" runat="server" ValueType="System.Int32" ValueField="IdUsuario" ClientInstanceName="cboUsuario" TextField="NomeUsuario"
                                Caption="Cadastrado por" Width="100%" DataSourceID="sdsUsuario" ShowShadow="false" DropDownStyle="DropDown" DataSecurityMode="Strict">
                                <CaptionSettings Position="Top" ShowColon="false" />
                                <ValidationSettings ErrorDisplayMode="ImageWithTooltip" Display="Dynamic" SetFocusOnError="true" ValidationGroup="a">
                                    <RequiredField IsRequired="true" ErrorText="Campo obrigatório" />
                                </ValidationSettings>
                        ...
                        <div class="col-sm-2 col-md-2 col-lg-2">
                            <dx:ASPxTextBox ID="txtRemessa" runat="server" ClientInstanceName="txtRemessa" Width="100%" Caption="Remessa para">
                                <CaptionSettings Position="Top" ShowColon="false" />
                            </dx:ASPxTextBox>
                        </div>
                    ...
                    <div class="col-sm-12 col-md-12 col-lg-12">
                        <div class="col-sm-12 col-md-12 col-lg-12">
                            <dx:ASPxMemo ID="memoObs" runat="server" Caption="Observação" Width="100%" Height="100px" ClientInstanceName="memoObs" MaxLength="5000">
                                <ClientSideEvents KeyUp="function(s, e){ var ele = s.GetText(); lblObs.SetText(ele.length + ' de 5000 Caracteres') }" />
                                <CaptionSettings Position="Top" ShowColon="false" />
                            </dx:ASPxMemo>
